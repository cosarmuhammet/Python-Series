# -*- coding: utf-8 -*-
"""
Created on Sun Jul 17 13:31:02 2022
...
class Calisan: 
    ...
    def __init__(self,isim,soyisim,maas):     #self = javadaki this   # Cosntructor
...
calisan2 = Calisan("ayse","ak",200)
calisan3 = Calisan("ayse","pak",600)
calisan4 = Calisan("ayse","bak",500)
